...
#icon
image_icon = PhotoImage(file = "F:/1_VSCode projects/OIBSIP/BMI calculator/bmi images/topicon.png")
app.iconphoto(False,image_icon)

#top
top = PhotoImage(file="F:/1_VSCode projects/OIBSIP/BMI calculator/bmi images/head.png")
...
#2boxes
box=PhotoImage(file="F:/1_VSCode projects/OIBSIP/BMI calculator/bmi images/box.png")
Label(app,image=box,bg="#f5f0e1").place(x=80,y=120)
Label(app,image=box,bg="#f5f0e1").place(x=350,y=120)


#scale
scale=PhotoImage(file="F:/1_VSCode projects/OIBSIP/BMI calculator/bmi images/scale.png")
...
def slider_changed(event):
    ...
    img = (Image.open("F:/1_VSCode projects/OIBSIP/BMI calculator/bmi images/man.png"))
